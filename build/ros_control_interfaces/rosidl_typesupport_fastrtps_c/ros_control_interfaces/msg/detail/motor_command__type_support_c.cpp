...
#include "ros_control_interfaces/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommand__ros_msg_type = ros_control_interfaces__msg__MotorCommand;
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_control_interfaces__msg__MotorCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_control_interfaces__msg__MotorCommand;
    is_plain =
      (
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_control_interfaces__msg__MotorCommand(
