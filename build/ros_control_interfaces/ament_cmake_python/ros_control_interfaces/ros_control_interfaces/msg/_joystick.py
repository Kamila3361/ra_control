...
class Metaclass_Joystick(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ros_control_interfaces')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ros_control_interfaces.msg.Joystick')
            logger.debug(
            ...
            from ros_control_interfaces.msg import MotorCommand
...
class Joystick(metaclass=Metaclass_Joystick):
    ...
    _fields_and_field_types = {
        'positions': 'sequence<ros_control_interfaces/MotorCommand>',
        'velocities': 'sequence<ros_control_interfaces/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_control_interfaces', 'msg'], 'MotorCommand')),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_control_interfaces', 'msg'], 'MotorCommand')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'positions' field must be a set or sequence and each value of type 'MotorCommand'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, MotorCommand) for v in value) and
                 True), \
                "The 'velocities' field must be a set or sequence and each value of type 'MotorCommand'"
