...
{
  new (message_memory) ros_control_interfaces::msg::MotorCommand(_init);
}

void MotorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_control_interfaces::msg::MotorCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommand_message_member_array[2] = {
  {
    ...
    offsetof(ros_control_interfaces::msg::MotorCommand, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_control_interfaces::msg::MotorCommand, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(ros_control_interfaces::msg::MotorCommand),
...
{
  return &::ros_control_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_control_interfaces, msg, MotorCommand)() {
  return &::ros_control_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
