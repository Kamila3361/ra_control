...
#include "ros_control_interfaces/msg/detail/joystick__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_control_interfaces::msg::MotorCommand &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_control_interfaces::msg::MotorCommand &);
...
// functions for ros_control_interfaces::msg::MotorCommand already declared above
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_control_interfaces
cdr_serialize(
  const ros_control_interfaces::msg::Joystick & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: positions
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros_control_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_control_interfaces::msg::Joystick & ros_message)
{
  // Member: positions
  {
    uint32_t cdrSize;
    ...
    for (size_t i = 0; i < size; i++) {
      ros_control_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: positions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ros_control_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: positions
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_control_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCommand(
  ...
  if (is_plain) {
    ...
    using DataType = ros_control_interfaces::msg::Joystick;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_control_interfaces::msg::Joystick *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_control_interfaces::msg::Joystick *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ros_control_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<ros_control_interfaces::msg::Joystick>()
{
  return &ros_control_interfaces::msg::typesupport_fastrtps_cpp::_Joystick__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_control_interfaces, msg, Joystick)() {
  return &ros_control_interfaces::msg::typesupport_fastrtps_cpp::_Joystick__handle;
}
